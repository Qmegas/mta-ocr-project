function [BH,mean_dist]=Lib_sc_compute(Bsamp,Tsamp,mean_dist,nbins_theta,nbins_r,r_inner,r_outer,out_vec)
...
r_array=real(sqrt(Lib_dist2(Bsamp',Bsamp'))); % real is needed to
